...
function malaysia() {
  ...
  cityDesc1Container.innerText = 'Seoul, the capital of South Korea,' +
  ...
  cityDesc2Container.innerText = 'Busan, a large port city in South Korea,' +
      ' is known for its beaches, mountains and temples.';
...
function brazil() {
  ...
  const cityDesc1Container = document.getElementById('cityDesc1');
  cityDesc1Container.innerText = 'Salvador, the capital of Brazil’s' +
  ...
  const cityDesc2Container = document.getElementById('cityDesc2');
  cityDesc2Container.innerText = 'Rio de Janeiro is a huge seaside' +
      ' city in Brazil, famed for its Copacabana and Ipanema beaches,' +
      ' 38m Christ the Redeemer statue atop Mount Corcovado and for Sugarloaf' +
      ' Mountain, a granite peak with cable cars to its summit.';
...
function southKorea() {
  ...
  const cityDesc2Container = document.getElementById('cityDesc2');
  cityDesc2Container.innerText = 'Busan, a large port city in South' +
  ...
  const cityDesc3Container = document.getElementById('cityDesc3');
  cityDesc3Container.innerText = 'Jeju province encompasses the ' +
